...
const sequelizeConnection = new Sequelize('postgres://gabrielbarriga@localhost:5432/testing-db', {
  logging: false
});
// const sequelizeConnection = new Sequelize('postgres://nikobellalewis@localhost:5432/testing-db', {
//   logging: false
// });
